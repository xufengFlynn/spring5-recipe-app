...
import flynn.springframework.spring5recipeapp.services.ImageService;
...
class ImageControllerTest {
    ...
    @Test
    void showUploadedForm() throws Exception {
    ...
    void getImageNumberFormatException() throws Exception {
        ...
        mockMvc.perform(get("/recipe/asdf/recipeimage")).andExpect(status()
                .isBadRequest())
